    ...
    for iter = 1:Nit
        ...
        for k = 1:V
            ...
            for n = 1:M
                ...
                Ivg(ind(1),k,n) = Igv(ind(2),k,n)-s2 +Igv(ind(3),k,n) - s3;
                Ivg(ind(2),k,n) = Igv(ind(1),k,n)-s1 +Igv(ind(3),k,n) - s3;
                Ivg(ind(3),k,n) = Igv(ind(1),k,n)-s1 +Igv(ind(2),k,n) - s2;
            end
        end
