...
public:
	...
	std::vector<uint8_t> encode(std::vector<uint8_t> info_bits, int nuser);
	std::vector<uint8_t>  encode_bp(std::vector<uint8_t> info_bits, int nuser);
	std::vector<uint8_t> decode_scl_llr(uint16_t list_size, std::vector<double> &llr, int nuser);
	void decode_jpscl_llr(uint16_t list_size, double **app, std::vector<std::vector<uint8_t>>& decodedResult); // JPSCL
	void decode_BP_Joint(double **app, std::vector<std::vector<uint8_t>>& detectedResult);
	std::vector<uint8_t> decode_BP_sep(std::vector<double> &llr, int nuser);
...
private:
	...
	std::vector<uint8_t> decode_scl(int nuser);
