...
void	Modulator(int **codeword, double ****chip, std::vector<std::vector<double>> map_16QAM);
...
void	MLDT(LDPC &ldpc, double variance, double ****H, double ***postRx, double **app, double **appLlr, double **refLlr, double ****estimate, std::vector<std::vector<double>> map_16QAM);
