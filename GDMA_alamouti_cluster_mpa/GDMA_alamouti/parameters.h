...
#define		NUM_LEVEL				( 1 << ( NUM_USER * NUM_TX ))					// number of levels of superimposed signal
...
#define		BLOCK_NUM				2000000											// number of blocks to be simulated
#define		BLOCK_LEN				8192							// number of symbols in a block
