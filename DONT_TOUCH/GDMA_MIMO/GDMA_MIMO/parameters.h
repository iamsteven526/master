...
#define		NUM_RX					1													// number of receive antennas
#define		L						2													// length of block code
...
void	AlamoutiEncoder(int **data, double ***tx, int **STBC_matrix);
void	SignalCombiner(double ***chCoef, double **rx, double ***postRx, int **SC_matrix);
