...
#define		BLOCK_NUM				300					// number of blocks to be simulated
#define		BLOCK_LEN				2000							// number of symbols in a block
#define		Cluster_Len				2000

#define		SNR_NUM					8									// number of SNR points to be simulated
...
void	Detecter(int **data, double **appLlr, long double &error, double** chCoef, int &ouch_block);
void	DiffDecoding(double *appLlr);

void	EnergyProfile(double **chCoef);
void	MultipleAccessChannel(double stdDev, double **chCoef, double **tx, double **rx, int index, int scma_matrix[SCMA_SOURCE][SCMA_SOURCE * NUM_USER / SCMA_USER_SOURCE]);
...
void	MLDT(double variance, double **chCoef, double **rx, double *app, double** appLlr, double **estimate, int i);
