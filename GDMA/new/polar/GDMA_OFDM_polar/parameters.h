...
#define		CRC_LEN					24												// number of bits in CRC
#define		LIST_SIZE				16												// list size 
...
#define		DATA_LEN				(512 - (CRC_LEN * POLAR_DECODING_TYPE))			// data length
